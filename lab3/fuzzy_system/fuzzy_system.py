...
from lab3.fuzzy_set.operations.binary_functions import FloatBinaryFunction, zadeh_and, zadeh_or, hamacher_t_norm
from lab3.fuzzy_set.operations.operations import binary_operation
