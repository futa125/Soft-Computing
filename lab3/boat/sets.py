from lab3.boat.domains import DISTANCE, ANGLE, ACCELERATION, SPEED, ORIENTATION
...
from lab3.fuzzy_set.operations.unary_functions import l_function, gamma_function
